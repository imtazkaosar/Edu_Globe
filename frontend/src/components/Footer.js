...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-slate-700 via-slate-800 to-slate-900 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 text-white transition-colors duration-300">
      {/* Main Footer Content */}
