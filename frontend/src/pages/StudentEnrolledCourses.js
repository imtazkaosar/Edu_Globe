    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900 py-8 px-4 sm:px-6 lg:px-8 transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {courses.map((course) => (
          <div
            key={course._id}
            className="glass-strong rounded-xl shadow-sm hover:shadow-md transition-shadow overflow-hidden border border-gray-200 dark:border-slate-700"
          >
            {/* Card Header */}
            ...
            <div className="p-6 bg-white dark:bg-slate-800">
              <div className="space-y-3 mb-4">
                ...
                <div className="flex items-center text-gray-900 dark:text-white font-semibold text-lg">
                  <svg
                    className="w-5 h-5 mr-2"
                    fill="none"
                    stroke="currentColor"
      ...
      {selectedCourse && (
        ...
        >
          <div
            className="glass-strong rounded-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto border border-gray-200 dark:border-slate-700"
          ...
          >
            ...
            <div className="p-6 bg-white dark:bg-slate-800">
              <div className="mb-6">
                <span className="inline-block px-3 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 rounded-full text-sm font-medium mb-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  ...
                  {/* Credits Section */}
                  <div className="p-4 bg-gray-50 dark:bg-slate-700/50 rounded-lg border border-gray-200 dark:border-slate-600">
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Credit Hours</p>
                    <p className="font-semibold text-gray-900 dark:text-white">
                  ...
                  {/* Schedule Section */}
                  <div className="p-4 bg-gray-50 dark:bg-slate-700/50 rounded-lg border border-gray-200 dark:border-slate-600">
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Schedule</p>
                    <p className="font-semibold text-gray-900 dark:text-white">
                  ...
                  {/* Price Section */}
                  <div className="p-4 bg-gray-50 dark:bg-slate-700/50 rounded-lg border border-gray-200 dark:border-slate-600">
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Course Fee</p>
                    <p className="font-semibold text-gray-900 dark:text-white">
                  ...
                  <>
                    ...
                    <div className="mb-6">
                      <textarea
                        ...
                        className="w-full border border-gray-300 dark:border-slate-600 rounded-lg p-3 text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-slate-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500"
                        rows="3"
                      />
                      <button
                          ...
                          {editingReviewId === review._id ? (
                            <>
                              <textarea
                                ...
                                className="w-full border border-gray-300 dark:border-slate-600 rounded-lg p-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-slate-800 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500"
                                rows="3"
                              />
                              <div className="mt-2 flex gap-2">
                                ...
                                <button
                                  ...
                                  className="px-3 py-1 bg-gray-300 dark:bg-slate-600 text-gray-700 dark:text-gray-300 rounded text-sm font-medium hover:bg-gray-400 dark:hover:bg-slate-500"
                                >
                                  Cancel
                                </button>
                              </div>
            ...
            <div className="sticky bottom-0 bg-white dark:bg-slate-800 border-t border-gray-200 dark:border-slate-700 px-6 py-4">
              <button
                onClick={closeModal}
                className="w-full py-3 bg-gray-100 dark:bg-slate-700 text-gray-700 dark:text-gray-300 rounded-lg font-medium hover:bg-gray-200 dark:hover:bg-slate-600 transition-colors"
              >
                Close
              </button>
            </div>
