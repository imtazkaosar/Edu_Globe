...
const SummaryApi = {
  ...
  getNotifications: (studentId) => ({
    url: `${backendDomain}/api/notifications?studentId=${studentId}`,
    method: "get",
  }),
  getUnreadNotificationCount: (studentId) => ({
    url: `${backendDomain}/api/notifications/unread-count?studentId=${studentId}`,
    method: "get",
  }),
  markNotificationAsRead: {
    url: `${backendDomain}/api/notifications/mark-read`,
    method: "post",
  },
  markAllNotificationsAsRead: {
    url: `${backendDomain}/api/notifications/mark-all-read`,
    method: "post",
  },

  // ------------------- PAYMENT APIS -------------------
  createPaymentIntent: {
    url: `${backendDomain}/api/payment/create-intent`,
    method: "post",
  },
  confirmPayment: {
    url: `${backendDomain}/api/payment/confirm`,
    method: "post",
  },
  getPaymentHistory: (studentId) => ({
    url: `${backendDomain}/api/payment/history?studentId=${studentId}`,
    method: "get",
  }),

  // ------------------- STUDENT PROFILE APIS -------------------
  createOrUpdateProfile: {
    url: `${backendDomain}/api/student-profile`,
    method: "post",
  },
  getStudentProfile: (studentId) => ({
    url: `${backendDomain}/api/student-profile?studentId=${studentId}`,
    method: "get",
  }),

  // ------------------- CHATBOT APIS -------------------
  getUniversitySuggestions: {
    url: `${backendDomain}/api/chatbot/university-suggestions`,
    method: "post",
  },
};
