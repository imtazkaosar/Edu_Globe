...
const studentProfileController = require("../controller/studentProfile/studentProfileController");
...
// ================= NOTIFICATION ROUTES =================
router.get("/notifications", authToken, notificationController.getNotificationsByStudent);
router.get("/notifications/unread-count", authToken, notificationController.getUnreadNotificationCount);
router.post("/notifications/mark-read", authToken, notificationController.markNotificationAsRead);
router.post("/notifications/mark-all-read", authToken, notificationController.markAllNotificationsAsRead);


// ================= PAYMENT ROUTES =================
router.post("/payment/create-intent", authToken, paymentController.createPaymentIntent);
router.post("/payment/confirm", authToken, paymentController.confirmPayment);
router.get("/payment/history", authToken, paymentController.getPaymentHistory);
// Webhook route - must use raw body parser for Stripe signature verification
router.post("/payment/webhook", bodyParser.raw({ type: 'application/json' }), paymentController.handleWebhook);


// ================= STUDENT PROFILE ROUTES =================
router.post("/student-profile", authToken, studentProfileController.createOrUpdateProfile);
router.get("/student-profile", authToken, studentProfileController.getStudentProfile);


// ================= CHATBOT ROUTES =================
router.post("/chatbot/university-suggestions", authToken, chatbotController.getUniversitySuggestions);
